...
class Contenedor {
    constructor(nombreArchivo){
        ...
        const data = "[]"
        fs.writeFile(ruta, data, (err, output) => {
            if(err){
                console.log("Fallo la creacion del archivo: " + err)
            }else{
                console.log(`Tu archivo ${this.nombreArchivo} se creo correctamente`)
            }
        })
    }
    // save(objeto){
...
// setTimeout(prueba.save({titulo: "producto1", price: 123}), 1000)
